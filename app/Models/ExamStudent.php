...
class ExamStudent extends Model
{
    ...
    */
    ...
    protected $fillable = ['sworn_declaration_item_id','exam_table_id','exam_act_id','regularity_id','plan_change_id','condition_exam','assistance_exam','written_qualification','oral_qualification','average','approved','promotion','observations'];
    // protected $hidden = [];
    // protected $dates = [];
