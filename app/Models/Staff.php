...
class Staff extends Model
{
    ...
    */
    ...
    {
        return $this->belongsToMany(\App\Models\Subject::class, 'staff_subjects')->withPivot('staff_id','start_date','end_date','job_id','weekly_hours','plant_type','end_date','resolution_number','subject_id');
    }
