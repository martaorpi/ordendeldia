...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-11-2021 a las 00:41:50
...
INSERT INTO `locations` (`id`, `description`, `departament_id`, `created_at`, `updated_at`) VALUES
...
ALTER TABLE `students`
  ...
  ADD CONSTRAINT `students_location_id_foreign` FOREIGN KEY (`location_id`) REFERENCES `locations` (`id`),
