...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('cycle') }}'><i class='nav-icon la la-question'></i> Ciclos</a></li>
...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('personal') }}'><i class='nav-icon la la-question'></i> Personal ISMP</a></li>
...
<li class="nav-item nav-dropdown">
    <a class="nav-link nav-dropdown-toggle" href="#"><i class="nav-icon la la-users"></i> Autenticacion</a>
