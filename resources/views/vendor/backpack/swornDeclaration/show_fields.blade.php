...
<div class="card">
    ...
    {{--@include('vendor.backpack.swornDeclaration.addItem', ['licenses' => \App\Models\StaffLicense::where('staff_id', $entry->id)->get()], ['staff_id' => $entry->id])--}}
    <div class="col-6"></div>
    @include('vendor.backpack.swornDeclaration.addItem', ['swornDeclarationItems' => \App\Models\SwornDeclarationItem::where('sworn_declaration_id', $entry->id)->get()], ['sworn_declaration_id' => $entry->id])
    </div>
</div>
@else
    @include('crud::inc.show_fields', ['fields' => $crud->getFieldsWithoutATab()])
